...
public class SendMailService
{
    ...
    public async Task<bool> SendEmailAsync(MailRequest mailRequest)
    {
        try
        {
            ...
            {
                await client.ConnectAsync(_config["Smtp:Server"], int.Parse(_config["Smtp:Port"] ?? throw new Exception("Not found Port for Stmp")), MailKit.Security.SecureSocketOptions.StartTls);
